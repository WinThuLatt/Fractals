...
public class MengerFractal implements Screen, InputProcessor
{
    int counter = 0;
    ...
    public MengerFractal(Fractals f)
    {
	this.f = f;
	hud = new HUD(f);
	...
	model = modelBuilder.createBox(r, r, r, new Material(ColorAttribute.createDiffuse(Color.GREEN)),
